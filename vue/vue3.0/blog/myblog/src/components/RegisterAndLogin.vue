...
export default class RegisterAndLogin extends Vue{
  ...
  private handleAuthor(): void {
    ...
    window.location.href = `https://github.com/login/oauth/authorize?client_id=592db51fb70a513e0f86&redirect_uri=http://localhost:8080/${preventHistory.name}`
  }
}
</script>
